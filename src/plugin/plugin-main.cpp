...
#ifdef __APPLE__
    const auto binary=QString::fromUtf8(obs_get_module_binary_path(obs_current_module()));
    QCoreApplication::addLibraryPath(QFileInfo(binary).absolutePath()+"/../Resources/qt-plugins");
#endif
